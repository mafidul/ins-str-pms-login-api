...
public class AsynchronousService {
	...
	@Async("asyncExecutor")
	public java.util.concurrent.CompletableFuture<LoginModel> findUser(String user) throws InterruptedException {
		LOGGER.info("Looking up " + user);
		String url = String.format("https://api.github.com/users/%s", user);
		LoginModel results = restTemplate.getForObject(url, LoginModel.class);
		Thread.sleep(1000L);
